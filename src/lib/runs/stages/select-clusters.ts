...
export async function selectClusters(input: {
  ...
  const generated = await generateGeminiJson(
    [
      ...
      "Primary clusters: prioritize Chilean national politics, domestic internal affairs (economy, institutions, policy, society at national scale), and Chile's diplomacy with regional neighbors and Latin America. Fill primary slots with the strongest clusters that match this editorial focus.",
      "Never assign to primary_clusters: (1) ongoing international military conflicts or great-power confrontations where Chile is not central—e.g. US–Iran–Israel hostilities and similar distant-war coverage; (2) crime and public-safety stories (use secondary_clusters at most); (3) sports (any sports story belongs in secondary_clusters or diffuse_clusters, never primary).",
      "Secondary clusters: use for high global salience that is not primary-tier for this brief—especially the conflict, crime, and sports categories above—plus other internationally important stories that do not fit the Chile/region primary focus.",
      "Notable passings may appear in primary only when the figure and story are clearly central to Chilean national politics, institutions, or the regional diplomatic themes above; otherwise use secondary or diffuse.",
